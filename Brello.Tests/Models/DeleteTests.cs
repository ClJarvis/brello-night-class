...
namespace Brello.Tests.Models
{
    ...
    public class BoardDeleteTest
    {
        ...
        [TestMethod]
        public void ListEnsureICanEditAList()
        {
            //Begin Arrange
            var data = my_list.AsQueryable();
            BoardRepository board_repo = new BoardRepository(mock_context.Object);
            ...
            BrelloList Updatedlist = new BrelloList { Title = "ToDo", BrelloListId = 1 };
            my_list.Add(new Board { Title = "My Next Board", Owner = user1, BoardId = 1 });
            //End Act
