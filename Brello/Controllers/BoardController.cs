    ...
    public class BoardController : Controller
    {
        ...
        public ActionResult Index()
        {
           ...
           ApplicationUser me = repository.Users.FirstOrDefault(u => u.Id == user_id);
            ...
            ViewBag.CurrentBoard = my_board.BoardId;
        ...
        {
            string list_name = form.Get("list_name");
            string board_id = form.Get("board_id");
             ...
             */
             //when user  submit redirect to page so they can see
